  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden bg-char-2 pb-0 pt-24 text-white">
        ...
        <div className="relative z-[2] mx-auto grid max-w-site items-center gap-10 px-[30px] py-14 sm:py-[82px] lg:min-h-[690px] lg:grid-cols-[.9fr_1.1fr] lg:gap-16 lg:py-[100px]">
          <Reveal>
            ...
            <h1 className="max-w-[680px] font-display text-[clamp(40px,10.8vw,70px)] font-extrabold leading-[.98] tracking-[-2px] text-white sm:tracking-[-2.5px]">
              Built to connect <span className="text-lime">.</span>
            </h1>
          ...
          <Reveal className="hidden sm:block lg:pl-3">
            <AboutPageVisual image={ABOUT.image} alt={ABOUT.imageAlt} priority />
          </Reveal>
        </div>
      ...
      {/* story */}
      <section id="our-story" className="relative bg-paper-2 py-20 md:py-[130px]">
        ...
        <div className="relative z-[2] mx-auto max-w-site px-[30px]">
          <Reveal>
            <div className="grid overflow-hidden rounded-[28px] border border-char/10 bg-paper shadow-[0_30px_80px_rgba(26,28,31,.14)] lg:grid-cols-[.78fr_1.22fr]">
              <div className="relative overflow-hidden border-b border-char/10 p-6 md:p-11 lg:border-b-0 lg:border-r">
                <div className="pointer-events-none absolute -left-24 -top-28 h-[300px] w-[300px] rounded-full bg-lime/15 blur-[90px]" />
                <div className="relative z-[2] flex h-full flex-col sm:min-h-[310px]">
                  ...
                  <div className="mt-auto hidden flex-wrap gap-2 pt-9 sm:flex">
              ...
              <div>
                {STORY_PILLARS.map((item, index) => (
                  <article
                    key={item.title}
                    className={`grid gap-4 p-6 md:grid-cols-[145px_1fr] md:gap-8 md:p-10 ${
      ...
      <section id="purpose" className="relative overflow-hidden bg-paper-2 py-20 md:py-[130px]">
        ...
        <div className="relative z-[2] mx-auto max-w-site px-[30px]">
          <Reveal className="mb-10 max-w-[700px] md:mb-14">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {PURPOSE.map((item) => (
              <Reveal key={item.label}>
                <article
                  className={`relative h-full overflow-hidden rounded-[22px] border p-6 md:p-10 ${
                    item.dark
                ...
                >
                  ...
                  <div className="relative z-[2] flex h-full flex-col sm:min-h-[245px]">
                    ...
                    <p
                      className={`mt-auto max-w-[520px] pt-8 font-display text-[18px] font-semibold leading-[1.45] tracking-[-.45px] sm:pt-12 sm:text-[21px] ${
          ...
          <Reveal className="mb-6 mt-14 md:mb-8 md:mt-20">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-2 lg:grid-cols-4">
            {VALUES.slice(0, 4).map((value, index) => (
              <Reveal key={value.title}>
                <article className="h-full rounded-2xl border border-char/10 bg-paper p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_35px_rgba(52,55,59,.08)] sm:p-6">
                  <span className="font-display text-[11px] font-bold text-lime-2">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  <h4 className="mt-4 font-display text-[15px] font-bold tracking-[-.35px] text-ink sm:mt-6 sm:text-[18px]">
                    {value.title}
                  </h4>
